	...
	while (window.isOpen())
    {
		...
		for (int level = level_init; level <= level_max; level++)
		{
			...
			if (level == 27)
			{
				...
				square_matrix[max_level + 25][max_level + 27] = 6;
				
				square_matrix[max_level + 27][max_level + 25] = 6;
				...
				square_matrix[max_level + 24][max_level + 27] = 5;
				
				square_matrix[max_level + 27][max_level + 24] = 5;
			...
			while (!level_change)
			{
				...
				{	
					...
					if ((abs(local_x + dir_direct[0]) <= size_level) &&
						...
						(((square_matrix[local_x + dir_direct[0] + max_level][local_y + dir_direct[1] + max_level] != 1) &&
						(square_matrix[local_x + dir_direct[0] + max_level][local_y + dir_direct[1] + max_level] != 10)) &&
						((square_matrix[local_x + dir_direct[0] + max_level][local_y + dir_direct[1] + max_level] == 9) && ))
					{
				...
				if ((level == 27) && delay_flipping && (delay_flip == -2))
				{
