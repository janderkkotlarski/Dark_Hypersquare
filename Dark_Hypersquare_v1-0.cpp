...
{  
  ...
  init_sprite(arrow_sprite, arrow_tex,
    ...
    std::cerr << bitmask_img << " not found!\n";
    ...
    std::cerr << bitsquare_img << " not found!\n";
    ...
    std::cerr << bitshadow_img << " not found!\n";
    ...
    std::cerr << bitshine_img << " not found!\n";
    ...
    std::cerr << bitmask_key_up_file << " not found!\n";
  ...
  key_up_sprite.setOrigin(sf::Vector2f(-3.5f*squarep, -3.5f*squarep));
    ...
    std::cerr << bitmask_key_right_file << " not found!\n";
    ...
    std::cerr << bitmask_key_down_file << " not found!\n";
