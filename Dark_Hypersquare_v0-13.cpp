...
int main()
{
	...
	std::string amazad_var = "Dark Hypersquare V0.13";
	...
	double compass_x_c = 0, compass_y_c = 1;
	
	double compass_x = 0, compass_y = 1;
	...
	arrow_sprite.setPosition(sf::Vector2f(compass_x - compass_x_c, compass_y - compass_y_c));
	...
	compass_sprite.setOrigin(sf::Vector2f(0.5*squarep, 0.5*squarep));
	
	compass_sprite.setPosition(sf::Vector2f(compass_x - compass_x_c, compass_y - compass_y_c));
	...
	while (window.isOpen())
    {
		...
		for (int level = 1; level <= level_max; level++)
		{
			...
			compass_x = compass_x_c;
			compass_y = compass_y_c;			
					...
					for (int actions = 1; actions <= transitions; actions++)
					{
						...
						if (turn_right || turn_left)
						{
							...
							if (actions <= 21)
							{
								...
								// compazz_x = compass_x*cos(pi*final_rot/180) - compass_y*sin(pi*final_rot/180);
								
								// compazz_y = compass_x*sin(pi*final_rot/180) + compass_y*cos(pi*final_rot/180);
								
								// compass_x = compazz_x;
								
								// compass_y = compazz_y;
								
								arrow_sprite.setPosition(sf::Vector2f(compass_x - compass_x_c + kompass_x, compass_y - compass_y_c + kompass_y));

								compass_sprite.setPosition(sf::Vector2f(compass_x - compass_x_c + kompass_x, compass_y - compass_y_c + kompass_y));
