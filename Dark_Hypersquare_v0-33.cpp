...
int main()
{
	...
	std::string chara_img = "Maruko_1.png";
	...
	sf::Texture chara_tex;
	
	if (!chara_tex.loadFromFile(chara_img))
	{
			
		std::cout << chara_img << " not found!\n";
			
	}
	
	sf::Sprite chara_sprite;
	chara_sprite.setTexture(chara_tex);
	
	chara_sprite.setOrigin(sf::Vector2f(16, 16));
	
	chara_sprite.setPosition(sf::Vector2f(0, -squarep));
			...
			while (!level_change)
			{
				...
				{	
						...
						!action)
					{
						...
						chara_sprite.move(sf::Vector2f(-level_side*squarep, 0));
						...
						!action)
					{
						...
						chara_sprite.move(sf::Vector2f(0, -level_side*squarep));
					...
					for (int actions = 1; actions <= transitions; actions++)
					{
						...
						if (moving)
						{
							...
							if (actions <= 21)
							{
								...
								chara_sprite.move(sf::Vector2f(final_move[0], final_move[1]));
							...
							else
							{
								...
								chara_sprite.move(-final_move[0], -final_move[1]);
