...
int main()
{
	...
	std::string amazad_var = "Dark Hypersquare V0.15";
	...
	double compass_x = 0, compass_y = 0;
					...
					for (int actions = 1; actions <= transitions; actions++)
					{
						...
						if (turn_right || turn_left)
						{
							...
							if (actions <= 21)
							{
								...
								// kompass_x = (compass_x_c - compass_x)*cos((pi*1.0*final_rot)/180) - (compass_y_c - compass_y)*sin((pi*1.0*final_rot)/180) + compass_x;
								
								// kompass_y = (compass_x_c - compass_x)*sin((pi*1.0*final_rot)/180) + (compass_y_c - compass_y)*cos((pi*1.0*final_rot)/180) + compass_y;
								
								// compass_x_c = kompass_x;
								
								// compass_y_c = kompass_y;
